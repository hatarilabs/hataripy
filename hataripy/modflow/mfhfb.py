...
the ModflowHfb class as `hataripy.modflow.ModflowHfb`.
...
class ModflowHfb(Package):
    ...
    nhfbnp: int
        ...
        is calculated automatically by hataripy based on the information in
    ...
    >>> hfb = hataripy.modflow.ModflowHfb(m, hfb_data=hfb_data)
    ...
    def load(f, model, ext_unit_dict=None):
        ...
        f : filename or file handle
            File to load.
        model : model object
            The model object (of type: class:`hataripy.modflow.mf.Modflow`)
        ...
        hfb : ModflowHfb object
            ModflowHfb object (of type :class:`hataripy.modflow.mfbas.ModflowHfb`)
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> hfb = hataripy.modflow.ModflowHfb.load('test.hfb', m)
