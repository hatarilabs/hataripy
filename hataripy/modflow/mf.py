...
from hataripy.discretization.modeltime import ModelTime
...
class Modflow(BaseModel):
    ...
    def __init__(self, modelname='modflowtest', namefile_ext='nam',
        ...
        self.mfnam_packages = {
            "zone": hataripy.modflow.ModflowZon,
            "mult": hataripy.modflow.ModflowMlt,
            "pval": hataripy.modflow.ModflowPval,
            "bas6": hataripy.modflow.ModflowBas,
            "dis": hataripy.modflow.ModflowDis,
            "disu": hataripy.modflow.ModflowDisU,
            "bcf6": hataripy.modflow.ModflowBcf,
            "lpf": hataripy.modflow.ModflowLpf,
            "hfb6": hataripy.modflow.ModflowHfb,
            "chd": hataripy.modflow.ModflowChd,
            "fhb": hataripy.modflow.ModflowFhb,
            "wel": hataripy.modflow.ModflowWel,
            "mnw1": hataripy.modflow.ModflowMnw1,
            "mnw2": hataripy.modflow.ModflowMnw2,
            "mnwi": hataripy.modflow.ModflowMnwi,
            "drn": hataripy.modflow.ModflowDrn,
            "drt": hataripy.modflow.ModflowDrt,
            "rch": hataripy.modflow.ModflowRch,
            "evt": hataripy.modflow.ModflowEvt,
            "ghb": hataripy.modflow.ModflowGhb,
            "gmg": hataripy.modflow.ModflowGmg,
            "lmt6": hataripy.modflow.ModflowLmt,
            "lmt7": hataripy.modflow.ModflowLmt,
            "riv": hataripy.modflow.ModflowRiv,
            "str": hataripy.modflow.ModflowStr,
            "swi2": hataripy.modflow.ModflowSwi2,
            "pcg": hataripy.modflow.ModflowPcg,
            "pcgn": hataripy.modflow.ModflowPcgn,
            "nwt": hataripy.modflow.ModflowNwt,
            "pks": hataripy.modflow.ModflowPks,
            "sms": hataripy.modflow.ModflowSms,
            "sfr": hataripy.modflow.ModflowSfr2,
            "lak": hataripy.modflow.ModflowLak,
            "gage": hataripy.modflow.ModflowGage,
            "sip": hataripy.modflow.ModflowSip,
            "sor": hataripy.modflow.ModflowSor,
            "de4": hataripy.modflow.ModflowDe4,
            "oc": hataripy.modflow.ModflowOc,
            "uzf": hataripy.modflow.ModflowUzf1,
            "upw": hataripy.modflow.ModflowUpw,
            "sub": hataripy.modflow.ModflowSub,
            "swt": hataripy.modflow.ModflowSwt,
            "hyd": hataripy.modflow.ModflowHyd,
            "hob": hataripy.modflow.ModflowHob,
            "vdf": hataripy.seawat.SeawatVdf,
            "vsc": hataripy.seawat.SeawatVsc
        }
        return
    ...
    def load_results(self, **kwargs):
        ...
        try:
            ...
            if oc.chedfm is None:
                head_const = hataripy.utils.HeadFile
            else:
                head_const = hataripy.utils.FormattedHeadFile
            if oc.cddnfm is None:
                ddn_const = hataripy.utils.HeadFile
            else:
                ddn_const = hataripy.utils.FormattedHeadFile
        ...
        if savebud and os.path.exists(self.cpth):
            bdObj = hataripy.utils.CellBudgetFile(self.cpth, model=self, **kwargs)
    ...
    def load(f, version='mf2005', exe_name='mf2005.exe', verbose=False,
        ...
        >>> import hataripy
        >>> ml = hataripy.modflow.Modflow.load('model.nam')
