...
the ModflowRch class as `hataripy.modflow.ModflowRch`.
...
class ModflowRch(Package):
    ...
    >>> rch = hataripy.modflow.ModflowRch(m, nrchop=3, rech=1.2e-4)
    ...
    >>> m = hataripy.modflow.Modflow()
    >>> rch = hataripy.modflow.ModflowRch(m, nrchop=3, rech=rech)
    ...
    def load(f, model, nper=None, ext_unit_dict=None, check=True):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> rch = hataripy.modflow.ModflowRch.load('test.rch', m)
