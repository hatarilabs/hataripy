...
the ModflowSwr1 class as `hataripy.modflow.ModflowSwr1`.
...
class ModflowSwr1(Package):
    ...
    >>> swr = hataripy.modflow.ModflowSwr1(m)
    ...
    def load(f, model, ext_unit_dict=None):
        ...
        swr : ModflowSwr1 object
            ModflowSwr1 object (of type :class:`hataripy.modflow.mfbas.ModflowSwr1`)
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> swr = hataripy.modflow.ModflowSwr1.load('test.swr', m)
