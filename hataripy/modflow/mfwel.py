...
the ModflowWel class as `hataripy.modflow.ModflowWel`.
...
class ModflowWel(Package):
    ...
    >>> wel = hataripy.modflow.ModflowWel(m, stress_period_data=lrcq)
    ...
    def load(f, model, nper=None, ext_unit_dict=None, check=True):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> wel = hataripy.modflow.ModflowWel.load('test.wel', m)
