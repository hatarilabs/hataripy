...
the ModflowZone class as `hataripy.modflow.ModflowZone`.
...
class ModflowZon(Package):
    ...
    >>> zonedict = hataripy.modflow.ModflowZon(m, zone_dict=zone_dict)
    ...
    def load(f, model, nrow=None, ncol=None, ext_unit_dict=None):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> zon = hataripy.modflow.ModflowZon.load('test.zon', m)
