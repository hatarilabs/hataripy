    ...
    def load(f, model, nper=None, nstp=None, nlay=None, ext_unit_dict=None):
        ...
        if ihedun > 0:
            ...
            try:
                ...
                if model.verbose:
                    print('head file name will be generated by hataripy')
        if iddnun > 0:
            unitnumber[2] = iddnun
            try:
                ...
                if model.verbose:
                    print('drawdown file name will be generated by hataripy')
        if ibouun > 0:
            unitnumber[4] = ibouun
            try:
                ...
                if model.verbose:
                    print('ibound file name will be generated by hataripy')
            if cboufm is None:
                cboufm = True
