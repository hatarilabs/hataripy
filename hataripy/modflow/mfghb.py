...
the ModflowGhb class as `hataripy.modflow.ModflowGhb`.
...
class ModflowGhb(Package):
    ...
    >>>                                   #stress periods
    >>> ghb = hataripy.modflow.ModflowGhb(ml, stress_period_data=lrcsc)
    ...
    def load(f, model, nper=None, ext_unit_dict=None, check=True):
        ...
        >>> ghb = hataripy.modflow.ModflowGhb.load('test.ghb', m)
