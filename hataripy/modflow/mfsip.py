...
the ModflowSip class as `hataripy.modflow.ModflowSip`.
...
class ModflowSip(Package):
    ...
    >>> sip = hataripy.modflow.ModflowSip(ml, mxiter=100, hclose=0.0001)
    ...
    def load(f, model, ext_unit_dict=None):
        ...
        >>> sip = hataripy.modflow.ModflowSip.load('test.sip', m)
