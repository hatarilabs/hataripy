...
the ModflowFhb class as `hataripy.modflow.ModflowFhb`.
...
class ModflowFhb(Package):
    ...
    ----------
    model : model object
        The model object (of type :class:`hataripy.modflow.mf.ModflowFhb`) to
    ...
    >>> fhb = hataripy.modflow.ModflowFhb(m)
    ...
    def load(f, model, nper=None, ext_unit_dict=None):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> fhb = hataripy.modflow.ModflowFhb.load('test.fhb', m)
