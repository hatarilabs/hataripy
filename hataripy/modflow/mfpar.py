...
the ModflowPar class as `hataripy.modflow.ModflowPar`.
...
class ModflowPar(object):
    ...
    def load(f, npar, verbose=False):
        ...
        >>>par_types, parm_dict = hataripy.modflow.mfpar.ModflowPar.load(f, np)
    ...
    def parameter_fill(model, shape, findkey, parm_dict, findlayer=None):
        ...
        >>> data = hataripy.modflow.mfpar.ModflowPar.parameter_fill(m, (nrow, ncol), 'vkcb',
