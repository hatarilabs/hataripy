...
class Mnw(object):
    ...
    def check(self, f=None, verbose=True, level=1):
        ...
        Returns
        -------
        chk : hataripy.utils.check object
...
class ModflowMnw2(Package):
    ...
    >>> mnw2 = hataripy.modflow.ModflowMnw2(ml, ...)
    ...
    def load(f, model, nper=None, gwt=False, nsol=1, ext_unit_dict=None):
        ...
        f : filename or file handle
            File to load.
        model : model object
            The model object (of type :class:`hataripy.modflow.ModflowMnw2`) to
        ...
        stress_period_data = {}  # stress period data table for package (hataripy convention)
        itmp = []
