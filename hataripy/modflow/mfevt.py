...
the ModflowEvt class as `hataripy.modflow.ModflowEvt`.
...
class ModflowEvt(Package):
    ...
    ----------
    model : model object
        The model object (of type :class:`hataripy.modflow.mf.ModflowEvt`) to which
    ...
    >>> evt = hataripy.modflow.ModflowEvt(m, nevtop=3, evtr=1.2e-4)
    ...
    def load(f, model, nper=None, ext_unit_dict=None):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> evt = hataripy.modflow.mfevt.load('test.evt', m)
