...
the ModflowDrn class as `hataripy.modflow.ModflowDrn`.
...
class ModflowDrn(Package):
    ...
    >>>                                   #stress periods
    >>> drn = hataripy.modflow.ModflowDrn(ml, stress_period_data=lrcec)
    ...
    def load(f, model, nper=None, ext_unit_dict=None, check=True):
        ...
        >>> drn = hataripy.modflow.ModflowDrn.load('test.drn', m)
