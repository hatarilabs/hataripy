...
the ModflowChd class as `hataripy.modflow.ModflowChd`.
...
class ModflowChd(Package):
    ...
    >>>                                     #stress periods
    >>> chd = hataripy.modflow.ModflowChd(m, stress_period_data=lrcd)
    ...
    def load(f, model, nper=None, ext_unit_dict=None):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> wel = hataripy.modflow.ModflowChd.load('test.chd', m)
