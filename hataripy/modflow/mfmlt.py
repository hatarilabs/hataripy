...
the ModflowMlt class as `hataripy.modflow.ModflowMlt`.
...
class ModflowMlt(Package):
    ...
    >>> mltdict = hataripy.modflow.ModflowZon(m, mult_dict=mult_dict)
    ...
    def load(f, model, nrow=None, ncol=None, ext_unit_dict=None):
        ...
        >>> import hataripy
        >>> m = hataripy.modflow.Modflow()
        >>> mlt = hataripy.modflow.ModflowMlt.load('test.mlt', m)
