...
the ModflowUzf1 class as `hataripy.modflow.ModflowUzf1`.
...
class ModflowUzf1(Package):
    ...
    etsquare : float (smoothfact)
        ...
        etsquare is activated in hataripy by specifying a real value
    ...
    netflux : list of [Unitrech (int), Unitdis (int)]
        ...
        netflux is activated in hataripy by specifying a list for
    ...
    >>> uzf = hataripy.modflow.ModflowUzf1(ml, ...)
    ...
    def __init__(self, model,
        ...
        if nwt_11_fmt:
            warnings.warn("nwt_11_fmt has been deprecated,"
                          ...
                          " please provide a hataripy.utils.OptionBlock object"
    ...
    def load(f, model, ext_unit_dict=None, check=False):
        ...
        >>> uzf = hataripy.modflow.ModflowUZF1.load('test.uzf', m)
