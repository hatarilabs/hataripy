...
class OptionBlock(object):
    ...
    package : hataripy.pakbase.Package instance
    ...
    def load_options(options, package):
        ...
        ----------
            ...
            package : hataripy.package type
                valid packages include hataripy.modflow.ModflowWel,
                hataripy.modflow.ModflowUzf1, hataripy.modflow.ModflowSfr2
