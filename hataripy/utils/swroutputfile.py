...
from ..utils.utils_def import hataripyBinaryData


class SwrFile(hataripyBinaryData):
    """
    ...
    >>> import hataripy
    >>> so = hataripy.utils.SwrFile('mymodel.swr.stage.bin')
...
class SwrStage(SwrFile):
    ...
    >>> import hataripy
    >>> stageobj = hataripy.utils.SwrStage('mymodel.swr.stg')
...
class SwrBudget(SwrFile):
    ...
    >>> import hataripy
    >>> stageobj = hataripy.utils.SwrStage('mymodel.swr.bud')
...
class SwrFlow(SwrFile):
    ...
    >>> import hataripy
    >>> stageobj = hataripy.utils.SwrStage('mymodel.swr.flow')
...
class SwrExchange(SwrFile):
    ...
    >>> import hataripy
    >>> stageobj = hataripy.utils.SwrStage('mymodel.swr.qaq')
...
class SwrStructure(SwrFile):
    ...
    >>> import hataripy
    >>> stageobj = hataripy.utils.SwrStage('mymodel.swr.str')
