...
class PathlineFile():
    ...
    >>> import hataripy
    >>> pthobj = hataripy.utils.PathlineFile('model.mppth')
    ...
    def get_data(self, partid=0, totim=None, ge=True):
        ...
        >>> import hataripy.utils.modpathfile as mpf
        >>> pthobj = hataripy.utils.PathlineFile('model.mppth')
        >>> p1 = pthobj.get_data(partid=1)
    ...
    def get_destination_pathline_data(self, dest_cells, to_recarray=False):
        ...
        >>> import hataripy
        >>> p = hataripy.utils.PathlineFile('modpath.pathline')
    ...
    def write_shapefile(self, pathline_data=None,
        ...
        mg : hataripy.discretization.grid instance
...
class EndpointFile():
    ...
    >>> import hataripy
    >>> endobj = hataripy.utils.EndpointFile('model.mpend')
    ...
    def get_destination_endpoint_data(self, dest_cells, source=False):
        ...
        >>> import hataripy
        >>> e = hataripy.utils.EndpointFile('modpath.endpoint')
    ...
    def write_shapefile(self, endpoint_data=None,
        ...
        sr : hataripy.utils.reference.SpatialReference instance
...
class TimeseriesFile():
    ...
    >>> import hataripy
    >>> tsobj = hataripy.utils.TimeseriesFile('model.timeseries')
    ...
    def get_destination_timeseries_data(self, dest_cells):
        ...
        >>> import hataripy
        >>> ts = hataripy.utils.TimeseriesFile('modpath.timeseries')
