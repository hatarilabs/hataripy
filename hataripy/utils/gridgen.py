...
class Gridgen(object):
    ...
    dis : hataripy.modflow.ModflowDis
        hataripy discretization object
    model_ws : str
    ...
    def _mfgrid_block(self):
        ...
        # lower left corner, whereas hataripy rotates around upper left.
        # gridgen rotation is counter clockwise, whereas hataripy rotation is
        # clock wise.  Crazy.
        xll = self.sr.xul
