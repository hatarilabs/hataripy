...
class hataripyBinaryData(object):
    """
    The hataripyBinaryData class is a class to that defines the data types for
    integer, floating point, and character data in MODFLOW binary
    files. The hataripyBinaryData class is the super class from which the
