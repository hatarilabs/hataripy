...
from hataripy.utils.utils_def import hataripyBinaryData
from hataripy.discretization.structuredgrid import StructuredGrid
from hataripy.discretization.vertexgrid import VertexGrid
from hataripy.discretization.unstructuredgrid import UnstructuredGrid
from hataripy.utils.reference import SpatialReferenceUnstructured
from hataripy.utils.reference import SpatialReference
import warnings

warnings.simplefilter('always', PendingDeprecationWarning)


class MfGrdFile(hataripyBinaryData):
    """
    The MfGrdFile class.
    ...
    --------
    >>> import hataripy
    >>> gobj = hataripy.utils.MfGrdFile('test.dis.grb')
    """
