...
the NamData class as `hataripy.modflow.NamData`.
...
class NamData(object):
    ...
    packages : dictionary
        ...
        `mfnam_packages` attribute of :class:`hataripy.modflow.mf.Modflow`.
...
def parsenamefile(namfilename, packages, verbose=True):
    ...
    packages : dict
        ...
        attribute of :class:`hataripy.modflow.mf.Modflow`.
    verbose : bool
    ...
    dict or OrderedDict
        ...
        :class:`hataripy.utils.mfreadnam.NamData` instance
