"""
Module spatial referencing for hataripy model objects
...
class SpatialReference(object):
    ...
    def get_grid_line_collection(self, **kwargs):
        ...
        """
        from hataripy.plot import ModelMap
...
class SpatialReferenceUnstructured(SpatialReference):
    ...
    def from_gridspec(cls, fname):
        ...
        Returns
        -------
            sru : hataripy.utils.reference.SpatialReferenceUnstructured
...
class epsgRef:
    ...
    user directory, otherwise in the user's 'HOME/.hataripy' directory.
    """
