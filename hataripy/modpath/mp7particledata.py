...
class ParticleData(object):
    ...
    >>> pd = hataripy.modpath.ParticleData(locs, structured=True, drape=0,
    ...
    def _get_dtype(self, structured, particleid):
        ...
        >>> import hataripy.modpath as fmp
...
class FaceDataType(object):
    ...
    >>> import hataripy
    >>> fd = hataripy.modpath.FaceDataType()
...
class CellDataType(object):
    ...
    >>> import hataripy
    >>> cd = hataripy.modpath.CellDataType()
...
class LRCParticleData(object):
    ...
    >>> import hataripy
    >>> pg = hataripy.modpath.LRCParticleData(lrcregions=[0, 0, 0, 3, 10, 10])
...
class NodeParticleData(object):
    ...
    >>> import hataripy
    >>> pg = hataripy.modpath.NodeParticleData(nodes=[100, 101])
