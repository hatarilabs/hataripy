...
class ModpathSim(Package):
    ...
    ----------
    model : model object
        The model object (of type :class:`hataripy.modpath.mp.Modpath`) to which
    ...
    >>> import hataripy
    >>> m = hataripy.modpath.Modpath()
    >>> dis = hataripy.modpath.ModpathSim(m)
    ...
    def __init__(self, model, mp_name_file='mp.nam', mp_list_file='mp.list',
        ...
        self.heading1 = '# MPSIM for Modpath, generated by hataripy.'
        self.heading2 = '#'
...
class StartingLocationsFile(Package):
    ...
    def __init__(self, model,
        ...
        self.model = model
        self.heading = '# Starting locations file for Modpath, generated by hataripy.'
