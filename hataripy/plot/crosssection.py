...
try:
    ...
    plt = None
from hataripy.plot import plotutil
from hataripy.utils import geometry
import warnings
...
class _CrossSection(object):
    ...
    model : hataripy.mf6.Modflow or hataripy.modflow.Modflow object
...
class _StructuredCrossSection(_CrossSection):
    ...
    modelgrid : hataripy.discretization.StructuredGrid
...
class ModelCrossSection(object):
    ...
    def __new__(cls, ax=None, model=None, dis=None, line=None,
        ...
        from hataripy.plot.plotbase import DeprecatedCrossSection
        from hataripy.discretization import StructuredGrid
