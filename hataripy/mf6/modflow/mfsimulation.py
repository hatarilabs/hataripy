...
from ..mfbase import PackageContainer, MFFileMgmt, ExtFileAction, \
                     PackageContainerType, MFDataException, hataripyException, \
                     VerbosityLevel
...
class MFSimulation(PackageContainer):
    ...
    >>> s = hataripy6.mfsimulation.load('my simulation', 'simulation.nam')
    ...
    def __init__(self, sim_name='sim', version='mf6',
        ...
        if not fpdata.valid:
            ...
            raise hataripyException(excpt_str)
    ...
    def __getattr__(self, item):
        ...
        md : Model or package object
            Model or package object of type :class:hataripy6.mfmodel or
            :class:hataripy6.mfpackage
    ...
    def load(cls, sim_name='modflowsim', version='mf6', exe_name='mf6.exe',
        ...
        Examples
        --------
        >>> s = hataripy6.mfsimulation.load('my simulation')
        """
        # initialize
    ...
    def plot(self, model_list=None, SelPackList=None, **kwargs):
        ...
        """
        from hataripy.plot.plotutil import PlotUtilities
