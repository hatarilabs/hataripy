...
class hataripyException(Exception):
    """
    ...
    def __init__(self, error, location=''):
        self.message = error
        Exception.__init__(self,
                           "hataripyException: {} ({})".format(error, location))
    ...
    def __init__(self, model=None, package=None, path=None,
        ...
        if mfdata_except is not None and \
            ...
            if mfdata_except is not None and \
                    ...
                    isinstance(mfdata_except, hataripyException)):
...
class PackageContainer(object):
    ...
    def get_module(package_file_path):
        ...
        # import
        return importlib.import_module("hataripy.mf6.modflow.{}".format(
            module_path))
